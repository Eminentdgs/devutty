...
from Devutty.modules import ALL_MODULES
from Devutty.modules.purge import client
from Devutty.modules.helper_funcs.chat_status import is_user_admin
from Devutty.modules.helper_funcs.filters import CustomFilters
from Devutty.modules.helper_funcs.misc import paginate_modules
from Devutty.modules.helper_funcs.alternate import typing_action
...
buttons += [[InlineKeyboardButton(text="♻️ ADD ME TO YOUR GROUP ♻️",
                                  url="t.me/Devutty_TgBot?startgroup=true"),
]]

buttons += [[InlineKeyboardButton(text="SOURCE CODE 💫",
                                  url="https://t.me/kannan_srank/49"),
...
HELP_STRINGS = f"""
`Hi.. I'm` ദേവൂട്ടി[🦋](https://telegra.ph/file/54ed9e0d6eef2cc730f12.jpg)
...
def start(update, context):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Helloi, ദേവൂട്ടി Here, How can I help you? 🧐")
