...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Devutty-log.txt"),
...
if ENV:
    ...
    from Devutty.config import Development as Config
...
client = TelegramClient("Devutty", api_id, api_hash)
...
from Devutty.modules.helper_funcs.handlers import CustomCommandHandler  # noqa
